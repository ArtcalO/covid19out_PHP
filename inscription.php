...
<html lang="en">
  <head>
    <title>COVID-19-OUT : Inscription</title>
    <meta charset="utf-8">
          ...
          <div class="card-body m-auto">
              ...
              <form action="inscription.php" method="POST">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="first_name" required id="name" placeholder="Nom">
                </div>

                <div class="form-group">
                    <input type="text" class="form-control" name="last_name" required id="second_name" placeholder="Prenom">
                </div>

                <div class="form-group">
                    <input type="text" class="form-control" name="username" required id="username2" placeholder="nom d'utilisateur">
                </div>

                <div class="form-group">
                    <input type="password" class="form-control" name="password" required id="password1" placeholder="mot de passe">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" name="password2" required id="password2" placeholder="confirmer votre mot de passe">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="email" required id="email1" placeholder="adresse electronique">
                </div>
                <div class="form-group">
                  <input type="submit" value="S'enregistrer" name="reg_user" class="btn btn-outline-primary btn-block btn-login font-weight-bold mb-2 text-white">
                </div>
              </form>
          </div>
